...
pub use service::{
    ...
    HumanRelatedRequest, HumanRelationKind, HumanRowClass, HumanSnapshotStatus, HumanSummary,
    HumanSupportDetail, HumanSurface, HumanSystemDetail, McpActionService, McpBindingAuthority,
    McpBindingError, McpBindingGrant, McpBindingIssue, McpItemPartition, McpResolvedScope,
    McpScopeMechanism, McpServiceAction, McpServiceError, McpServiceItem, McpServiceRequest,
    McpServiceResult, McpServiceStatus, RuntimeMode,
};
